...
| normalTexture | [mesh17::materialtexture](materialtexture.md) | The normal map texture. |
| occlusionTexture | [mesh17::materialtexture](materialtexture.md) | The normal map texture. |
| emissiveTexture | [mesh17::materialtexture](materialtexture.md) | _TBD_: may not support this |
| emissiveFactor | number[3] | _TBD_: may not support this |
| pbrMetallicRoughness | [mesh17::pbrmetallicroughness](pbrmetallicroughness.md) | A set of parameter values that are used to define the metallic-roughness material model from Physically-Based Rendering (PBR) methodology. When not specified, all the default values of pbrMetallicRoughness apply. |
