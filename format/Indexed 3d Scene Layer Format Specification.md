...
<em>Table 33: Parameters of a function for generating the ID of an image.</em>
...
<p>Table 34: Attribute data types supported by a scene service layer.</p>
</div>  
...
<em>Table 35: Metadata of an SLPK.</em>
...
<em>Table 36: A typical example showing the layout of a SceneService in a key value store environment. The example illustrates the structure of the service using a 3D Object scene layer containing textured geometries as well as attribute data.</em>
