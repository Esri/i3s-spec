...
*/
{
	...
	"capabilities" : ["View", "Query", "Edit"], // capabilities possible on this layer. If not served by a 3D Scene Server (e.g. exported by CityEngine), "View" only.
	"store": { // information on the store (a grouping of 1..* layers to a shared index and resource set) of which this layer is a part.
		...
		"resourcePattern": ["3dNodeIndexDocument", "SharedResource", "FeatureData", "Geometry", "Texture"], // The resources need for rendering and the required order in which the client should load them.
