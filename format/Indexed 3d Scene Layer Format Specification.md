...
In I3S verison 1.7, an [MD5](https://en.wikipedia.org/wiki/MD5) [hash](../docs/1.7/slpk_hashtable.cmn.md) was introduced to improve loading time.  The hash must be the last item at the end of the central directory and named `@specialIndexFileHASH128@`.  
