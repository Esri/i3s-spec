/**
	Example i3s 1.3 3d Scene Layer Resource for the pointclouds profile..
*/
{
	...
	"name": "LIDAR Scan 2014-03-03", // the name of this layer.
	"alias": "LIDAR Scan 2014-03-03", // the display alias to be used for this layer.
	"description" : "This layer contains an Airborne LiDAR data set, filtered to 10 points/square meter.", // Cache description 
	"copyrightText" : "Vermessungsamt der Stadt Zürich", // copyright/usage information
	"capabilities" : ["View"], // capabilities possible on this layer. In pointclouds, "View" only.
