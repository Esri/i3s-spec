{
	...
	"name" : "ZurichBuildings", // name of this cache.
	"geometryType" : "FeatureMesh", // Geometry type for the cache. Options: FeatureMesh, IntegratedMesh, RasterTerrain, TINTerrain, Point, Line, Polygon
	"description" : "This cache contains textured Building features for the City of Zurich.\n", 
	"nidEncoding": "application/json+gzip", // MIME type for the encoding used for the Node Index documents. (initial option: JSON)
	"featureEncoding": "application/json+gzip", // MIME type for the encoding of feature data. (initial option: JSON)
	"geometryEncoding": "application/tabin+gzip", // MIME type for the encoding used for the geometry binary files (initial option: Typed Array Binary)
	"textureEncoding": "image/ASTC", // MIME type for the encoding used for textures in this cache. Options: JPEG, PNG, later maybe ASTC.
	...
	"rootNode": "./nodes/0", // relative URL to root node.
	"indexingScheme": "EsriRTree", // name of the indexing scheme used (for informative purposes). Options: Quadtree, Octtree, EsriRTree
	"copyrightText" : "Vermessungsamt der Stadt Zürich", // metadata...
	"extent" : {
		"xmin" : 8.54,  
		"ymin" : 47.385,  
		"xmax" : 8.72,
		"ymax" : 47.455, 
		"spatialReference" : {
		  "wkid" : 4325 // WKID identifying the SRS used by all parts of the same cache. Alternatively, a OGC URN could be used (advantage: can be composite and include a vertical datum ref as well)
		}
	}, 
    "layers" : [ // the list of layers contained in this cache.
		{
			...
			"typeName": "3dcim.BuildingShell", // the feature class name behind this layer.
			"defaultVisibility" : true, 
			"capabilities" : "View,Query,Edit", // capabilities possible on this layer. If generated by CE, "View" only.
			...
			"drawingInfo": { // symbology defined here will override any material definitions existing on features in the cache.
				"renderer": {
					"symbol" : {
