{
	...
	"featureData": [ // an array of feature data bundles belonging to this node.
		{ 
				...
				"layerContent": ["Public Buildings", "Transport Buildings"] // Indicates features of which layers have been encoded in this bundle. Allows the client to determine which bundles to load if only a subset of layers in cache is to be laoded.
		},
		{ 
				"href": "./features/1",
