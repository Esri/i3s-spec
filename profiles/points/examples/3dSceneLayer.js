...
*/
{
	...
	"store": { // information on the store (a grouping of 1..* layers to a shared index and resource set) of which this layer is a part.
		...
		"profile": "points", // i3s 1.5. Indicates which profile this scene store fulfills. One of {features-meshes, features-polygons, features-points, features-lines, analytics, meshpyramids, pointclouds, symbols}.
		...
		"attributeEncoding": "application/octet-stream+gzip; version=1.5", // MIME type for the encoding used for the binnary Attribute Resources
