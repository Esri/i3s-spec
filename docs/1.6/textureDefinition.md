...
[sharedResource](sharedResource.md)
### Properties
...
| images | [image](image.md)[] | An image is a binary resource, containing a single raster that can be used to texture a feature or symbol. |
